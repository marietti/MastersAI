...
if __name__ == "__main__":
    ...
    df = pd.read_csv(
        "C:\\Users\\nickb\source\\repos\\MastersAI\\ZigbeeFileParser\\FileParsing\\No_ms\\output4_5_Seconds_Discrete.csv")

    y = np.reshape(np.array(df["0xaf65"].tolist()), (1, np.array(df["0xaf65"].tolist()).size))
