...
for x in timeintervals:
    df = pd.read_csv("C:\\Users\\nickb\source\\repos\\MastersAI\\ZigbeeFileParser\\FileParsing\\Training\\cc2531_sniffer_2_3_2021_Trainingout_" + x + "_Seconds_Count.csv")
    ...
    pr = cProfile.Profile()
    pr.enable()
    [score1, _, _] = change_detection(y[:, 0:n*2+k-1], n, k, alpha, 5)
    ...
    numpy.savetxt("C:/Users/nickb/source/repos/MastersAI/ZigbeeFileParser/FileParsing/Training/" + x + "_second_final_score.csv", plot_array, delimiter=",")
    plot(plot_array)
    # axis([0, y_axis, 0, 100])
