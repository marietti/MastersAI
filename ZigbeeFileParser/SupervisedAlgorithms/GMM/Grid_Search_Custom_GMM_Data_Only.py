...
fo = open("Custom_Grid_Search_Out_Cross_Validation_GMM_Data_Only.csv", 'w', newline='', encoding='utf-8')
fo.writelines(
...
for x in timeintervals:
    ...
    # define dataset
    df = pd.read_csv(folder + file + x + "_Seconds_Count_Data_Only.csv")
    df_3 = pd.read_csv(folder_3 + file_3 + x + "_Seconds_Count_Data_Only.csv")
