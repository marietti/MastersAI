...
fo = open("Custom_Grid_Search_Out_Cross_Validation_Data_Only_Parse_Entrance", 'w', newline='', encoding='utf-8')
fo.writelines(
    'depth,estimator,learning_rate,sensors_input,true positive rate c1,true positive rate c2,true negative rate c1,'
