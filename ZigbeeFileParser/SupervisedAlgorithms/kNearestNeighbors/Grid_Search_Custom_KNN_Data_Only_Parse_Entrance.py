...
fo = open("Custom_Grid_Search_Out_Cross_Validation_Data_Only_Parse_Entrance.csv", 'w', newline='', encoding='utf-8')
fo.writelines(
    'c,gamma,kernel,sensors_input,true positive rate c1,true positive rate c2,true negative rate c1,'
